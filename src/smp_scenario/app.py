...
По умолчанию в системе загружен сценарий с названием **base**. Данный сценарий автоматические загружается при построении
дашборда, а также можно выгрузить входные и выходные данные по нему.
"""
