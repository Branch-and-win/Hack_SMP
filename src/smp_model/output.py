    ...
    def create_output(self):
        ...
        result_departures = [
            [
                ...
                self.input.config.start_date + timedelta(hours=d.time * self.input.config.hours_in_interval),
                self.input.config.start_date + timedelta(hours=(d.time + d.duration) * self.input.config.hours_in_interval),
                 d.vessel.class_type,
